...
## inspect the response variable (divide by numb of subjects and reps):
...
## logisitc regression model 1:
gf1 <- glm(stable ~ Sex+Age+Height+Weight+Surface+Vision,
          family = binomial,
          data= ctsib)
sumary(gf1)

## logisitc regression model 2, adding subject as a fixed effect:
